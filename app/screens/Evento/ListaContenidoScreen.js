...
import { consultar, consultarContenido, consultarNoProcesado } from "../../Services/ProductosSrv";
...
export const ListaContenido = ({ navigation }) => {
  ...
  const recuperarProductos = async () => {
    ...
    await consultarContenido(setPedidos);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cajaCabecera}>
        <Text style={{ fontSize: theme.fontSize.title,textAlign:"center" }}>Lista de Tareas</Text>
      </View>
      <View style={styles.cajaCuerpo}>
        <TarjetaContenido pedidos={pedidos} navegar={navigation} />
      ...
      <FAB
                ...
                onPress={() => {
                    navigation.navigate("AniadirContenido")
                }}
            />
