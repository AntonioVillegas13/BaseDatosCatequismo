...
import { AddActive, AddContenido, consultarActivo } from "../../Services/ActivosSrv";
...
import { consultar1Contenido, consultarContenido } from "../../Services/ProductosSrv";

export function AniadiContenido({ route, navigation }) {
  const [Idaux, setId] = useState("Contenido-");
  const [Titulodelcontenido, setTitulodelcontenido] = useState("");
  ...
  const AñadirProducto = async () => {
    ...
    console.log("Objeto", {
      NActivo: Idaux,
      Titulodelcontenido: Titulodelcontenido,
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <TextInput
          ...
          value={Titulodelcontenido}
          onChangeText={setTitulodelcontenido}
          mode="outlined"
          keyboardType="default"
        />
        <TextInput
        ...
        >
          ...
          >
            <StyledText > Agrega tu tarea Aqui!!</StyledText>
            <View
              style={{
        ...
        <View style={styles.cajaBotones}>
          <Button
            ...
            onPress={async () => {
              AñadirProducto();
              navigation.navigate("ListaContenido");
              // console.warn("array", Urls);
            }}
            buttonStyle={{
              borderRadius: 10,
