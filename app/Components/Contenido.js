...
import { addElementToArray } from "../Services/ProductosSrv";

export const TarjetaContenido = (props) => {
        ...
        <View style={{ margin: 10 }}>
          <View style={styles.ViewRow}>
            ...
            <View style={{ justifyContent: "center" }}>
              <Text> {prod.NActivo + "" + prod.Titulodelcontenido} </Text>
            </View>
            ...
            <TouchableHighlight
              onPress={() => {
                ...
                props.navegar.navigate("DetalleContenido", {
                  id: prod.NActivo,
                });
              }}
            >
          ...
          <Button
                ...
                onPress={async() => {
                    ...
                    const data = await AsyncStorage.getItem('@miApp:usuario');
                    console.log("usuario:",data)
                    addElementToArray(prod.NActivo,data)
                }}
